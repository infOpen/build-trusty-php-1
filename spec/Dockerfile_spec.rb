...
describe 'Dockerfile' do
    ...
    it 'install require packages to run php jobs' do
        expect(package('php5')).to be_installed
        expect(package('php5-cli')).to be_installed
        expect(package('php5-common')).to be_installed
        expect(package('php5-gd')).to be_installed
        expect(package('php5-imagick')).to be_installed
        expect(package('php5-mcrypt')).to be_installed
        expect(package('php5-mysql')).to be_installed
        expect(package('php5-xdebug')).to be_installed
        expect(package('php5-xsl')).to be_installed
        expect(package('graphviz')).to be_installed
        expect(package('libgv-php5')).to be_installed
    end

    it 'install mysql server' do
